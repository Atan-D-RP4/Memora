...
const MemScoreEvaluation = () => {
  ...
  const initTileRecall = (roundOverride = null) => {
    const round = roundOverride !== null
      ? roundOverride
      : tileRecall.currentRound;
    ...
    console.log(
      `Tile Recall Round ${
        round + 1
      }: ${sequenceLength} tiles, ${showTime}ms show time`,
    );
  ...
  const startTileRound = (
    gridSize = tileRecall.gridSize,
    sequenceLength = tileRecall.sequenceLength,
    showTime = tileRecall.showTime,
  ) => {
    const totalTiles = gridSize * gridSize;

    console.log(
      `Starting round with ${sequenceLength} tiles on ${gridSize}x${gridSize} grid`,
    );
  ...
  const handleTileClick = (tileIndex) => {
    ...
    if (newUserSequence.length === tileRecall.sequence.length) {
      const isCorrect = newUserSequence.every((tile, index) =>
        tile === tileRecall.sequence[index]
      );
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              if (tileRecall.currentRound < tileRecall.totalRounds - 1) {
                ...
                const correctRounds = newRoundScores.filter((score) =>
                  score > 0
                ).length;
                ...
                const finalScore = Math.max(
                  1,
                  Math.round(baseScore - wrongPenalty),
                );
  ...
  const finishEvaluation = () => {
    const speedScore = Math.max(
      1,
      (speedTest.correctAnswers / speedTest.totalQuestions) * 10,
    );
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-lg leading-relaxed">
          Before we begin your personalized learning journey, we need to
          establish your baseline MemScore. This quick evaluation will help our
          Neuro Engine understand your cognitive patterns and optimize your
          learning experience.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="text-center">
            ...
            <p className="text-gray-400">
              Match pairs of cards to test working memory
            </p>
          </div>
          <div className="text-center">
            ...
            <AnimatePresence mode="wait">
                    ...
                    <div className="text-left bg-gray-900/50 border border-white/10 rounded-xl p-6 space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-gray-300">
                          You'll see a 4×4 grid of cards with emoji symbols
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-0.5">
                        ...
                        <p className="text-gray-300">
                          First, all cards will be revealed for{" "}
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-gray-300">
                          After the preview, cards will flip back and you can
                          start clicking to find matching pairs
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-0.5">
                        ...
                        <p className="text-gray-300">
                          Your score depends on how few moves and wrong attempts
                          you make
                        </p>
                      </div>
                    </div>
              ...
              {currentPhase === "memory-game" && (
                ...
                >
                  <div className="mb-8">
                    ...
                    <p className="text-gray-400">
                      Find all matching pairs by flipping cards. Remember their
                      positions!
                    </p>
                  </div>
                        ...
                        ? (
                          <div className="text-center mb-4">
                            ...
                            <div className="text-blue-400 font-semibold">
                              Memorize the cards! Game starts in{" "}
                              {memoryGame.previewTimeLeft} seconds
                            </div>
                          </div>
                        )
                        : (
                          <>
                            <div className="flex justify-between items-center text-sm text-gray-400 mb-4">
                              ...
                              <span>
                                Wrong Attempts: {memoryGame.wrongAttempts}
                              </span>
                              <span>
                                Matches: {memoryGame.matchedCards.length /
                                  2}/{memoryGame.cards.length / 2}
                              </span>
                            </div>
                            <div className="w-full bg-gray-700 rounded-full h-2">
                              <div
                                ...
                                style={{
                                  width: `${
                                    (memoryGame.matchedCards.length /
                                      memoryGame.cards.length) * 100
                                  }%`,
                                }}
                              />
                            </div>
                        ...
                        <motion.div
                          ...
                          className={`w-20 h-20 rounded-lg border-2 cursor-pointer flex items-center justify-center text-4xl font-bold transition-all duration-300 ${
                            memoryGame.showingPreview ||
                              ...
                              memoryGame.matchedCards.includes(index)
                    ...
                    {memoryGame.gameComplete && (
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-300">
                          Moves: {memoryGame.moves} | Wrong Attempts:{" "}
                          {memoryGame.wrongAttempts}
                        </div>
                      </motion.div>
                    )}
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="text-left bg-gray-900/50 border border-white/10 rounded-xl p-6 space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-gray-300">
                          You'll see a 5×5 grid of tiles for{" "}
                          <strong className="text-white">5 rounds</strong>
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-0.5">
                        ...
                        <p className="text-gray-300">
                          Watch as tiles light up in sequence with numbers (3,
                          4, 5, 6, 7 tiles per round)
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-0.5">
                        ...
                        <p className="text-gray-300">
                          After the sequence disappears, click the tiles in the
                          {" "}
                          <strong className="text-white">same order</strong>
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-0.5">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-gray-300">
                          Each round gets faster and longer - stay focused!
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="bg-gray-900/50 border border-white/10 rounded-xl p-8 mb-6">
                    <div className="mb-6">
                      <div className="flex justify-between items-center text-sm text-gray-400 mb-4">
                        <span>
                          Round {tileRecall.currentRound + 1} of{" "}
                          {tileRecall.totalRounds}
                        </span>
                        <span>
                          Grid: {tileRecall.gridSize}×{tileRecall.gridSize}
                        </span>
                      ...
                      <div className="w-full bg-gray-700 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${
                              ((tileRecall.currentRound + 1) /
                                tileRecall.totalRounds) * 100
                            }%`,
                          }}
                        />
                      </div>
                    ...
                    <div className="py-4">
                      ...
                      <div className="h-12 mb-4 flex items-center justify-center">
                        ...
                        {tileRecall.isUserTurn && (
                          <div className="text-green-400 font-semibold">
                            Tiles placed:{" "}
                            {tileRecall.userSequence.length}/{tileRecall
                              .sequenceLength}
                          </div>
                        )}
                      ...
                      <div className="flex justify-center mb-4">
                        <motion.button
                          whileHover={tileRecall.isUserTurn &&
                              tileRecall.userSequence.length > 0
                            ? { scale: 1.05 }
                            : {}}
                          whileTap={tileRecall.isUserTurn &&
                              tileRecall.userSequence.length > 0
                            ? { scale: 0.95 }
                            : {}}
                          onClick={tileRecall.isUserTurn &&
                              tileRecall.userSequence.length > 0
                            ? handleUndoMove
                            : undefined}
                          disabled={!tileRecall.isUserTurn ||
                            tileRecall.userSequence.length === 0}
                      ...
                      <div
                        className={`grid gap-2 mx-auto ${
                          tileRecall.currentRound < 2
                            ? "max-w-sm"
                            : tileRecall.currentRound < 4
                            ? "max-w-md"
                            : "max-w-lg"
                        } ${
                          tileRecall.gridSize === 3
                            ? "grid-cols-3"
                            : tileRecall.gridSize === 4
                            ? "grid-cols-4"
                            : "grid-cols-5"
                        }`}
                      >
                        {Array.from({
                          length: tileRecall.gridSize * tileRecall.gridSize,
                        }).map((_, index) => {
                          const isInSequence = tileRecall.sequence.includes(
                            index,
                          );
                          const sequenceIndex = tileRecall.sequence.indexOf(
                            index,
                          );
                          const isCurrentlyShowing =
                            tileRecall.isShowingSequence && isInSequence;
                          const isShowingCorrect =
                            tileRecall.showingCorrectSequence && isInSequence;
                          const isUserClicked = tileRecall.userSequence
                            .includes(index);
                          const userClickIndex = tileRecall.userSequence
                            .indexOf(index);
                          ...
                          return (
                            ...
                            >
                              ...
                              {isUserClicked && !tileRecall.isShowingSequence &&
                                !tileRecall.showingCorrectSequence &&
                                (userClickIndex + 1)}
                            </motion.div>
                          );
              ...
              {currentPhase === "speed-test-instructions" && (
                ...
                >
                  <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-4">
                      Processing Speed Instructions
                    </h2>
                    <div className="text-left bg-gray-900/50 border border-white/10 rounded-xl p-6 space-y-4">
                      <div className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-0.5">
                          1
                        </div>
                        <p className="text-gray-300">
                          You have{" "}
                          ...
                          {" "}
                          to solve as many math problems as possible
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-0.5">
                        ...
                        <p className="text-gray-300">
                          Problems include addition, subtraction, and
                          multiplication
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-gray-300">
                          ...
                          <strong className="text-white">Enter</strong>{" "}
                          or click Submit
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-gray-300">
                          Work quickly but accurately - speed and precision both
                          matter!
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-900/50 border border-white/10 rounded-xl p-8 mb-6">
                    <div className="mb-6">
                      <div className="text-sm text-gray-400 mb-2">
                        Question {speedTest.currentQuestion + 1} of{" "}
                        {speedTest.totalQuestions} • Time: {speedTest.timeLeft}s
                      </div>
                      <div className="w-full bg-gray-700 rounded-full h-2">
                        <div
                          className="bg-orange-400 h-2 rounded-full transition-all duration-300"
                          style={{
                            width: `${(speedTest.timeLeft / 30) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                ...
                >
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold mb-4">
                      Your MemScore Results
                    </h2>
                    <p className="text-gray-400 text-lg">
                      Congratulations! Your cognitive baseline has been
                      established.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-gray-900/50 border border-white/10 rounded-xl p-6">
                      ...
                      <div className="text-sm text-gray-400">
                        {tileRecall.roundScores.filter((s) => s > 0)
                          .length}/{tileRecall.totalRounds} rounds correct
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-900/50 border border-white/10 rounded-xl p-6">
                      ...
                      <div className="text-sm text-gray-400">
                        {speedTest.correctAnswers}/{speedTest.totalQuestions}
                        {" "}
                        in 30s
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-900/50 border border-white/10 rounded-xl p-6 mb-8 text-left">
                    ...
                    <div className="space-y-3 text-sm text-gray-300">
                      {testResults.memoryGame >= 8 && (
                        <p>
                          • Excellent working memory! You can handle complex,
                          multi-layered learning materials.
                        </p>
                      )}
                      {testResults.tileRecall >= 8 && (
                        <p>
                          • Strong spatial memory indicates you'll excel at
                          visual and sequential learning.
                        </p>
                      )}
                      {testResults.processingSpeed >= 8 && (
                        <p>
                          • High processing speed means you can benefit from
                          rapid-fire review sessions.
                        </p>
                      )}
                      {testResults.overallScore < 6 && (
                        <p>
                          • We'll start with shorter, more frequent review
                          sessions to build your confidence.
                        </p>
                      )}
                      <p>
                        • Your Neuro Engine will adapt review intervals based on
                        these cognitive patterns.
                      </p>
                      <p>
                        • Expect your MemScore to improve as you use Memora's
