class JournalService {
  ...
  addActivity(activityText) {
    ...
    console.log(
      "📝 Journal: Saved to localStorage with key:",
      this.getUserStorageKey(`activities_${today}`),
    );
  ...
  updateJournalEntry() {
    ...
    console.log(
      "📝 Journal: Current journal entry exists:",
      !!localStorage.getItem(this.getUserStorageKey(`journal_${today}`)),
    );
    ...
    console.log(
      "📝 Journal: Saved updated journal entry to localStorage with key:",
      this.getUserStorageKey(`journal_${today}`),
    );
    console.log(
      "📝 Journal: Study summary updated - Topics:",
      topicCount,
      "Focus Sessions:",
      focusSessions,
      "Total Time:",
