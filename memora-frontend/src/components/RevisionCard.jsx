...
const RevisionCard = (
  { revision, onStart, onComplete, onPostpone, onViewDocs },
) => {
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center space-x-3 mb-3">
            ...
            {/* Difficulty Badge */}
            <div
              className={`px-2 py-1 rounded-full text-xs font-medium border ${difficultyConfig.bg} ${difficultyConfig.border} ${difficultyConfig.text}`}
            >
              <div className="flex items-center space-x-1">
                <div
                  className={`w-1.5 h-1.5 rounded-full ${difficultyConfig.dot}`}
                />
            ...
            {/* Status Badge */}
            <div
              className={`px-2 py-1 rounded-full text-xs font-medium border ${statusConfig.bg} ${statusConfig.border} ${statusConfig.text}`}
            >
              <div className="flex items-center space-x-1">
