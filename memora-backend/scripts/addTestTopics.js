...
const testTopics = [
  {
    ...
    content:
      "Understanding asynchronous programming in JavaScript with Promises and async/await syntax. Key concepts include promise chaining, error handling, and parallel execution.",
    difficulty: 4,
    category: "Technology",
  ...
  },
  {
    ...
    content:
      "Study of unsaturated hydrocarbons including their structure, properties, and reactions. Focus on addition reactions, polymerization, and stereochemistry.",
    difficulty: 5,
    category: "Science",
  ...
  },
  {
    ...
    content:
      "Major events and dates of World War II from 1939-1945. Key battles, political decisions, and turning points that shaped the outcome of the war.",
    difficulty: 2,
    category: "History",
  ...
  },
  {
    ...
    content:
      "Advanced integration technique using the formula ∫u dv = uv - ∫v du. Practice with trigonometric, exponential, and logarithmic functions.",
    difficulty: 4,
  ...
  },
  {
    ...
    content:
      "Essential Spanish vocabulary for business contexts including meetings, negotiations, finance, and professional communication.",
    difficulty: 2,
    category: "Language",
