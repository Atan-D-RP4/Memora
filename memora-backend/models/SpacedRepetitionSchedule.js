...
spacedRepetitionScheduleSchema.index({
  userId: 1,
  status: 1,
  scheduledDate: 1,
});
...
spacedRepetitionScheduleSchema.methods.complete = function (
  quality,
  actualDuration,
) {
...
spacedRepetitionScheduleSchema.methods.reschedule = function (
  newDate,
  reason = "user_request",
) {
...
spacedRepetitionScheduleSchema.statics.getOverdueItems = function (
  userId,
  limit = 20,
) {
  return this.find({
...
spacedRepetitionScheduleSchema.statics.getUpcomingSchedule = function (
  userId,
  days = 7,
  limit = 50,
) {
...
spacedRepetitionScheduleSchema.statics.getByTimeSlot = function (
  userId,
  timeSlot,
  date = new Date(),
) {
...
spacedRepetitionScheduleSchema.statics.getWorkload = function (
  userId,
  startDate,
  endDate,
) {
...
spacedRepetitionScheduleSchema.statics.optimizeSchedule = function (
  userId,
  targetDate,
  maxDailyItems = 20,
) {
...
const SpacedRepetitionSchedule = mongoose.model(
  "SpacedRepetitionSchedule",
  spacedRepetitionScheduleSchema,
);
